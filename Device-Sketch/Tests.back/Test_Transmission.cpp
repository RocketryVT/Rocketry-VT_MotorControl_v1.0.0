...
int TestTransmission() {
	...
	cout << "=== Begining Test for Packet Compilation ===" << endl;	
...
bool Test_0x51() {
	...
	cout << "-- Begining Test for 0x51" << endl;
...
bool Test_0x10() {
	...
	using namespace Transmission;
	using namespace Hardware;
	cout << "-- Begining Test for 0x10" << endl;
...
bool Test_0x52() {
	...
	using namespace Transmission;
	using namespace Hardware;
	cout << "-- Begining Test for 0x52" << endl;
