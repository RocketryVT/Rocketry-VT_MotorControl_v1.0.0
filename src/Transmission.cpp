...
*/
void Transmission::buildPacket(std::deque<unsigned char> &str, unsigned int &len, unsigned int type)
{
...
*/
void Transmission::xorchecksum(const std::deque<unsigned char> &str,
    unsigned int len, unsigned char &c0, unsigned char &c1)
{
	c0 = 0;
	c1 = 0;
	unsigned int i = 0;
